...
urlpatterns = [
    ...
    path('detallePinturaCompra/<int:id>', views.detallePintura, name="detallePinturaCompra" ),
    ...
    path('misPinturasAprobadas', views.pinturas_pintor, name='misPinturasAprobadas'),
    path('misPinturas', views.mis_pinturas, name='misPinturas')
